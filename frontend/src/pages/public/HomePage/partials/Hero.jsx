        ...
        <div className="relative min-h-screen flex flex-col align-center justify-center px-4" id="home">
            ...
            <div className="container max-w-5xl mx-auto text-center">
                <div className="space-y-1 ">
                    <div className="mb-4">
                        <h1 className="opacity-0 font-semibold animate-fade-in-delay-1 text-3xl md:text-4xl text-primary-foreground">
                            BEM VINDO AO GUIA
                        </h1>
            ...
            <a href="#about" className="absolute bottom-5 left-0 right-0 flex flex-col items-center text-primary-foreground opacity-75 animate-bounce z-16">
