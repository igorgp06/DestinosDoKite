        ...
        <main className="relative min-h-screen flex flex-col align-center justify-center px-4" id="home">
            ...
            <div className="container max-w-3xl mx-auto text-center z-10">
                <div className="space-y-8 ">
                    ...
                    <div>
                        <p className="text-lg text-primary-foreground opacity-0 animate-fade-in-delay-3">
                ...
                <div className="mt-10 opacity-1 animate-fade-in-delay-4">
                    <Link
                        to="/destinos"
                    ...
                    <Link
                        to="/contato"
                        className={cn("inline-block px-4 py-3 bg-background text-primary-foreground font-semibold", "border border-primary-foreground rounded-md shadow-md hover:bg-primary/90 hover:text-glow transition-all duration-300 ml-4")}
                    >
                        Entre em Contato
                    </Link>
            ...
            <div className="absolute bottom-10 left-1/2 transform-translate-x-1/2 flex flex-col items-center text-primary-foreground opacity-70 animate-bounce">
